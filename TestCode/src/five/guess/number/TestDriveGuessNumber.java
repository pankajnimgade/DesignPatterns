...
public class TestDriveGuessNumber {
    ...
    private static void startGame() {
        ...
        do {
            System.out.println(KEY_QUESTION + (int) current_Guess + " ?");
...
//            System.out.println(response);
        ...
        if (response.equalsIgnoreCase(KEY_YES)) {
            int temp_int = (int) current_Guess;
            System.out.println("Your Guessed Number is " + temp_int);
        }
...
//        System.out.println("increasing called, " + "Current: " + current_Guess + " Previous: " + previous_Guess);
        if (current_Guess != 0) {
            ...
            if (range_Guess != 0) {
                ...
                range_Guess = increment_in_guess;
            }
